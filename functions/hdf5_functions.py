...
def delete_group(group_name, hdf5_file):
	"""
...
def read_dataset_from_group(group_name, dataset, hdf5_file, start_slice = None, end_slice = None, stride = 1, verbose = False):
	"""
...
def save_data_to_group_hdf5(group, data, data_name, hdf5_file, meta_data = None, overwrite = False, create_group_if_not_exists = True, max_sec_sleep = 5):
	"""
...
def save_multi_data_to_group_hdf5(group, data, data_name, hdf5_file, meta_data = None, overwrite = False, create_group_if_not_exists = True):
	"""
...
def read_metadata_from_group(group_name, hdf5_file):
	"""
...
def save_meta_data_to_group(group_name, meta_data, hdf5_file):
	"""
...
def get_datasets_from_group(group_name, hdf5_file):
	"""
